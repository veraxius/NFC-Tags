...
export default async function PartnerExploreDetail({ params }: { params: Promise<{ id: string }> }) {
  await requireUser();
  ...
  return (
    <div className="space-y-4">
      <Link href="/partner/explore" className="text-xs font-medium text-[var(--color-pink)] hover:underline">
        ‹ Explore
      </Link>
